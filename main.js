...
//     for (const item in user) {
//         if (item === 'address') {
//             const divkaAddress = document.createElement('div');
//             div.append(divkaAddress);
//             for (const el in user[item]) {
//                 const divochka = document.createElement('div');
//                 divkaAddress.append(divochka);
//                 divochka.innerText = user.address[el];
//             }
//         } else  {
//             const divka = document.createElement('div');
//             div.append(divka);
//             divka.innerText = user[item];
//         }
//     }
// }
//
...
//                 div.append(title);
//                 title.innerText = rule[item];
//             } else {
//                 const body = document.createElement('p');
//                 div.append(body);
//                 body.innerText = rule[item];
//             }
//         }
//     }